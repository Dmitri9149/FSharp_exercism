// it is very difficult to understand the "output format" in the task 
// it is taking too long time for me 
// I took the working solution from here 
// https://github.com/tomi/fsharp-exercism/blob/master/12-beer-song/BeerSong.fs
module BeerSong
